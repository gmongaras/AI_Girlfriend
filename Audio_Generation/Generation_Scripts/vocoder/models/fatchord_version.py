...
class WaveRNN(nn.Module):
    ...
    def generate(self, mels, batched, target, overlap, mu_law, progress_callback=None, fade=True):
        ...
        # output2 = np.zeros((output.shape[0], output.shape[1]*2), dtype=np.float64)
        # output2[:, ::2] = output
        # output2[:, 1::2] = output
        # output = output2
